...
while True:
    try:
        ...
        #
        # De paso reconfirma "gaveta sacada" (led/recogida) y "gaveta ya
        # devuelta" (puesta) en cada vuelta. Los avisos normales son un POST
        # suelto en el momento del cambio (ver gavetas.py:_avisar); si ese
        # POST se pierde por un handshake TLS lento o un corte breve de wifi,
        ...
        if (gav and http_client is not None and backend_cfg is not None and
            ...
            if orden and orden.get("success"):
                ...
                # LEDs fisicos por gaveta (1 = de siempre; el puesto piloto
                # recablea a 3). Mismo sitio y mismo motivo que micros_cfg:
                # va en cada sondeo para que una placa recien reiniciada lo
                # recupere sola.
